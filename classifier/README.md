# CLAS12 SIDIS classifier sandbox

This demo uses [`hipopy`](https://pypi.org/project/hipopy/) to create and read
CLAS12 HIPO files. It is organized as `CLAS/classifier` so the parent `CLAS`
repository can grow to include other CLAS studies later.
